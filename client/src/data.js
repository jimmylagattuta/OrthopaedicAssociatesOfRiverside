...
export const aboutObj = [
    {
        nameOne: "About Los Angeles Orthopedic Surgery Specialists",
        descriptionOne:
            'Located in East Los Angeles and Downtown Los Angeles, Los Angeles, San Gabriel Valley, Santa Fe Springs, San Fernando Valley, Tarzana, San Fernando Valley, Encino, Santa Clarita, Newhall, San Gabriel Valley, Montebello and Glendale, CA',
        descriptionTwo: [
            "Los Angeles Orthopedic Surgery Specialists provides compassionate, high-quality orthopedic care to help patients reach lifelong wellness.",
            "The experienced team of medical providers sees patients from in and around Los Angeles, with offices in East Los Angeles, Wilshire, Santa Fe Springs, Tarzana, Encino, Valencia, and Montebello, California.",
            "Los Angeles Orthopedic Surgery Specialists knows there’s no such thing as a one-size-fits-all solution, so they use a customized approach to help each patient understand their condition and treatment plan. In addition, the team offers preventive and podiatric care that helps patients to avoid pain and live more active lives.",
            "Most treatments, including joint injections, diabetic foot care, and arthritis care, happen in the state-of-the-art Los Angeles Orthopedic Surgery Specialists’ offices.",
            "The locations also have on-site digital X-ray equipment for imaging tests, and the team works with White Memorial Medical Center in Los Angeles for advanced imaging including MRI and CT scans. The professionals perform most surgeries at White Memorial Medical Center or the Plaza Surgery Center in Monterey Park.",
...
export const aboutTerms = [
    {
        subtitle: null,
        body: [
            "Los Angeles Orthopedic Surgery Specialists's website is offered to you conditioned on your acceptance without modification of the terms, conditions, and notices contained herein. Your use of this practice website constitutes your agreement to all such terms, conditions, and notices.",
        ],
    },
    {
